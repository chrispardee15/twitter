...
//THIS VERSION HAS WORKING TWEET INPUT BUT NO LOG IN, TWEET LOOPING BUG HAS BEEN FIXED
//THAT BUG WAS CAUSED BY THE QUERY OF THE MAIN LOOP NOT AWARE OF INDISTINCT VALUES, ALL I DID WAS ADD SELECT DISTINCT
//BASICALLY THE QUERY ISN'T WRITTEN WELL BUT IT WORKS NOW
        ...
        <div class="row">
            ...
            <div class="span4" id="secondary">
                <div class="module mini-profile">
                    ...
                    <form action = "twitter-insert-chris-2.jsp" method = "POST">

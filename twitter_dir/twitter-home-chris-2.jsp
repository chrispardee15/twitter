...
<%
//THIS VERSION HAS TWEET LOOPING WORKING AND THE MAIN THING THAT DOESN'T WORK IS HASHTAG LINKS
...
<body class="user-style-theme1">
	...
	java.sql.PreparedStatement ps = conn.prepareStatement("select tweet, tweetID from cpardee.tweet_t, cpardee.stalker_t where cpardee.tweet_t.userID = cpardee.stalker_t.following and cpardee.stalker_t.follower=?");
	ps.setString(1,key);

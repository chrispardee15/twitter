...
<%
String backVersion = "twitter-signin-chris-back-04.jsp";//the current page to pass login credentials to
String upversion = "twitter-signup-chris-03.jsp";
String uperror="";
String logerror= "";
String logmessage = "";
if(request.getParameter("logout") != null){
	logmessage = request.getParameter("logout");
}
...
<!--<%out.println(uperror); out.println(logerror);%>-->
  ...
  <!--Error printouts-->
	...
	<%
		...
		// String loggy = request.getParameter("logout");
		//out.println("loggy"+loggy);
		//if(request.getParamerter("logout").equals("")) out.println("why??");
		if(logmessage.equals("true"))
		{
		//out.println("yolo");
		String outsuccess = "you have successfully logged out!";
		//out.print
	%>
		<div class="alert alert-success alert-dismissible" role="alert" style="position:fixed; z-index: 99;">
  			<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
  			<%=outsuccess%>
		</div>
		<%

...
<%String backVersion = "twitter-signin-chris-back-01.jsp";//the current page to pass login credentials to%>
<!-- This version has a working login -->
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
  ...
  <div class="front-card">
    ...
    <div class="front-signup"> <!--Sign Up!!-->
      ...
      <form action="twitter-signin-chris-back-01.jsp" class="signup" method="post">
        <div class="fullname">
          <input type="text" id="signup-user-name" autocomplete="off" maxlength="20" name="user[name]" placeholder="Full name">
        </div>
        <div class="email">
          <input type="text" id="signup-user-email" autocomplete="off" maxlength="20" name="user[email]" placeholder="Email">
        </div>
        <div class="password">
